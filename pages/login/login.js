...
Page({
  ...
  savePwd:function(){
    ...
    wx.setStorageSync('userLoginInfo', {'userName':this.data.body.userName,
    'userPwd':aesPassword});
  },
  ...
  var login_url= app.globalData.url+"/user/login?username="+this.data.userName+"&aesPassword="+aesPassword+"&appId="+app.globalData.appId+"&nonce_str="+nonce_str+"&sign="+signVal;
              var self=this;
        wx.request({//登录
          url: login_url,
          data: {},
              ...
              if (res.code) {
                ...
                wx.getUserInfo({
                  success: function(userRes) {
                    ...
                    //发起网络请求
                    wx.request({
                      url:  app.globalData.url+'/user/weixinLogin',
                      data: {
                        js_code: res.code,
